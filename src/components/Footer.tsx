    ...
    <footer className="bg-white border-t text-gray-700 text-sm">
      <div className="max-w-7xl mx-auto px-4 py-10 flex flex-col md:flex-row justify-between gap-10">
        ...
        <div className="flex-1 max-w-md">
          ...
          {/* 
          <p className="mb-2">Email Group Legal & Corporate Secretary: <a href="mailto:corporate.secretary@ioh.co.id" className="text-blue-600">corporate.secretary@ioh.co.id</a></p>
          <p className="mb-4">Email Investor Communication: <a href="mailto:investor@ioh.co.id" className="text-blue-600">investor@ioh.co.id</a></p>
            */}
      ...
      {/* Bottom bar */}
      <div className="bg-gray-800 text-white py-4 text-center text-xs">
